...
<div id="container">
  ...
  <div id="content"><!-- InstanceBeginEditable name="Contenido" -->
    <div id="listarH">
      <ul>
        <li><a href="../public/registrar/libro.php">Registrar Libro</a></li>
        <li><a href="../public/registrar/lugar.php">Registrar Lugar</a></li>
        <li><a href="../public/registrar/editorial.php">Registrar editorial</a></li>
        <li><a href="../public/registrar/procedencia.php">Registrar procedencia</a></li>
      </ul>
