...
<div id="container">
  <div id="header">
    <h1><!-- TemplateBeginEditable name="Título" -->Título<!-- TemplateEndEditable --></h1>
  </div>
  ...
  <div id="content"><!-- TemplateBeginEditable name="Contenido" -->Contenido<!-- TemplateEndEditable --></div>
