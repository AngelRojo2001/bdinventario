...
<div id="container">
  ...
  <div id="content"><!-- InstanceBeginEditable name="Contenido" -->
    <div id="listarH">
      <ul>
        <li><a href="../public/buscar/numero.php">Buscar por Número</a></li>
        <li><a href="../public/buscar/autor.php">Buscar por Autor</a></li>
        <li><a href="../public/buscar/titulo.php">Buscar por Título</a></li>
        <li><a href="../public/buscar/fecha.php">Buscar por Fecha</a></li>
      </ul>
