...
if (isset($_POST['titulo'])) {
  $colname_libro = $_POST['titulo'];
}
mysql_select_db($database_conex, $conex);
$query_libro = sprintf("SELECT * FROM libro WHERE titulo LIKE %s ORDER BY titulo ASC", GetSQLValueString("%" . $colname_libro . "%", "text"));
...
<div id="container">
  <div id="header">
    <h1><!-- InstanceBeginEditable name="Título" -->Buscar Título<!-- InstanceEndEditable --></h1>
  </div>
  ...
  <div id="content">
    ...
    <div id="mostrar"><!-- InstanceBeginEditable name="Contenido2" -->
      <form id="form1" name="form1" method="post" action="titulo.php">
        <table align="center">
          <tr>
            <th>Título:</th>
            <td><span id="vtitulo">
              <input name="titulo" type="text" class="fields_contact_us" id="titulo" />
              <br />
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("vtitulo");
//-->
      </script>
