...
$colname_libro = "-1";
if (isset($_POST['nro'])) {
  $colname_libro = $_POST['nro'];
}
mysql_select_db($database_conex, $conex);
$query_libro = sprintf("SELECT nro, fecha, autor, titulo FROM libro WHERE nro = %s", GetSQLValueString($colname_libro, "int"));
...
<div id="container">
  <div id="header">
    <h1><!-- InstanceBeginEditable name="Título" -->Buscar Número<!-- InstanceEndEditable --></h1>
  </div>
  ...
  <div id="content">
    ...
    <div id="mostrar"><!-- InstanceBeginEditable name="Contenido2" -->
      <form id="form1" name="form1" method="post" action="numero.php">
        <table align="center">
          <tr>
            <th>Número:</th>
            <td><span id="vnumero">
            <input name="nro" type="text" class="fields_contact_us" id="nro" />
            <br />
      ...
      <?php if ($totalRows_libro > 0) { // Show if recordset not empty ?>
        <p>Resultado del número <strong><em><?php echo $row_libro['nro']; ?></em></strong>:</p>
        <table border="1" cellspacing="0" class="spacio">
          <tr>
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("vnumero", "integer");
//-->
    </script>
