...
if (isset($_POST['fecha'])) {
  $colname_libro = $_POST['fecha'];
}
mysql_select_db($database_conex, $conex);
$query_libro = sprintf("SELECT nro, fecha, autor, titulo FROM libro WHERE fecha = %s", GetSQLValueString($colname_libro, "date"));
...
<div id="container">
  <div id="header">
    <h1><!-- InstanceBeginEditable name="Título" -->Buscar Fecha<!-- InstanceEndEditable --></h1>
  </div>
  ...
  <div id="content">
    ...
    <div id="mostrar"><!-- InstanceBeginEditable name="Contenido2" -->
      <form id="form1" name="form1" method="post" action="fecha.php">
        <table align="center">
          <tr>
            <th>Fecha:</th>
            <td><span id="vfecha">
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("vfecha", "date", {format:"yyyy-mm-dd", hint:"aaaa-mm-dd"});
//-->
      </script>
