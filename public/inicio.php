...
<div id="container">
  <div id="header">
    <h1><!-- InstanceBeginEditable name="Título" -->Inicio<!-- InstanceEndEditable --></h1>
  </div>
  ...
  <div id="content"><!-- InstanceBeginEditable name="Contenido" -->
    <p>Bienvenido a los registros de libros para el inventario.</p>
    <p>Espero que sea de su agrado este diseño y sea muy amigable para usted.</p>
