...
<div id="container">
  <div id="header">
    <h1><!-- InstanceBeginEditable name="Título" -->Registrar Editorial<!-- InstanceEndEditable --></h1>
  </div>
        ...
        <table align="center">
          <tr valign="baseline">
            ...
            <td><span id="veditorial">
              <input name="nombre" type="text" class="fields_contact_us" value="" size="32" />
              <br />
              <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="submit" class="submit_button" value="Insertar Editorial" /></td>
          </tr>
        </table>
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("veditorial");
//-->
      </script>
