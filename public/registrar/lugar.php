...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO lugar (nombre) VALUES (%s)",
...
<div id="container">
  <div id="header">
    <h1><!-- InstanceBeginEditable name="Título" -->Registrar Lugar<!-- InstanceEndEditable --></h1>
  </div>
  ...
  <div id="content">
    ...
    <div id="mostrar"><!-- InstanceBeginEditable name="Contenido2" -->
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            <th nowrap="nowrap" align="right" valign="top">Lugar:</th>
            <td><span id="vlugar">
              <input name="lugar" type="text" class="fields_contact_us" id="lugar" />
              <br />
              <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
          </tr>
          <tr valign="baseline">
            <th nowrap="nowrap" align="right">&nbsp;</th>
            <td><input type="submit" class="submit_button" value="Insertar Lugar" /></td>
          </tr>
        </table>
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("vlugar");
//-->
      </script>
